  ...
  <header>
    <div class="flex bg-primary-500 border-b border-primary">
      <RouterLink class="ms-2 flex flex-row items-center pe-2 gap-2" exact to="/">
        <img class="h-[30px] align-middle" src="@/assets/tiq-logo.svg" alt="TIQ Logo" />
        <span class="text-slate-200 text-xl md:hidden lg:inline text-nowrap">TIQ Platform</span>
      </RouterLink>
