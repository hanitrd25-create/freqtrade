...
# #----------------------------------
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #print(f'>>>>>>>>>>>>>>>>>>>>> {dataframe.columns.vatralues}')
    ...
    #    dataframe_tuple = self.dp.get_analyzed_dataframe(pair, self.timeframe)
    #    dataframe['atr'] = ta.ATR(dataframe, timeperiod=14)
        
        # Ensure dataframe is a Pandas DataFrame object
    #    if isinstance(dataframe_tuple, tuple):
    #        dataframe = dataframe_tuple[0]
    #    else:
    #        dataframe = dataframe_tuple
    ...
    #        raise KeyError("'atr' column not found in dataframe")
